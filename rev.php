...
<!DOCTYPE html>
<html>
    <title>Review Us || CENTRAL ASIA CASING</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row team_columns_carousel_wrapper">
                ...
                <h1>Review</h1>
                    ...
                    <?php 
                        $_koneksi = mysqli_connect('localhost','root','','on_shop');
                        ...
                        ('$name','$surname','$email','$phone','$message')";
                            ...
                            if(mysqli_query($_koneksi,$query)){
                            echo 'Review anda sudah terkirim. Terima Kasih';
                            }
                        }
