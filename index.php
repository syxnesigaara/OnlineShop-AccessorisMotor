...
<!DOCTYPE html>
<html>
	<title>Online Shop Accessoris Motor</title>
	<meta charset="utf-8">
...
<!-- Header Nav ============================================================== -->
  <div class="header-blue">
    <nav class="navbar navbar-default navigation-clean-search">
      <div class="container">
        <div class="navbar-header"><a href="index.php" class="navbar-brand font-weight-bold page-scroll"> <img src="assets/img/logo.jpg" width="200px" height="50px"></a>
...
<!-- Header Nav End --><br>
   ...
   <!-- Carousal ================================================================ -->
      ...
      <a href="product.php"><img src="assets/img/CAC.png" style="width:100%;"></a>
      <div class="carousel-caption">
		  ...
		  <div class="item">
			<a href="product.php"><img src="assets/img/slides/3.jpg" style="width:100%;"></a>
			<div class="carousel-caption">
			</div>
		  </div>

		  <div class="item">
			<a href="product.php"><img src="assets/img/slides/2.jpg" style="width:100%;"></a>
			<div class="carousel-caption">

			</div>
		  </div>
		  <div class="item">
			<a href="product.php"><img src="assets/img/slides/1.jpg" style="width:100%;"></a>
			<div class="carousel-caption">
         ...
         <div class="row team_columns_carousel_wrapper">
	      ...
	      echo '<div class="modal-body">';              
              echo '<div class="col-lg-4"><img src="assets/img/product/'.$obj->product_img_name.'"></div>
                    ...
                    <p><h3><strong>Price (Per Unit)</strong>:Rp '.$obj->price.'</h3></p>
